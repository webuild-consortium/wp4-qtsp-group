...
Because WeBuild QES integration is expected to lean on CSC-based remote signing, CSC API v2.2 terminology and endpoint structure should be considered rather than older CSC versions.
