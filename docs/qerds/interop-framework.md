...
- [QERDS protocol profiles](architecture.md#protocol-profiles), in particular interface **16. Message relay**
...
## QERDS technical underpinnings

Several options exist for realizing the QERDS. The leading candidate is AS4 2.0 but several other options are possible. Below is a short list of the most promising candidates. The list was selected based on the following criteria:
